 ...
 function calculateZakah() {
     ...
     document.getElementById("silver-t").innerText = silver;

     document.getElementById("currency-t").innerText = localCurrency;

     document.getElementById("bank-t").innerText = moneyDeposited;

     document.getElementById("bond-t").innerText = prizeBonds;

     document.getElementById("fund-t").innerText = providentFund;

     document.getElementById("commitee-t").innerText = commitee;

     document.getElementById("raw-t").innerText = rawMaterials;

     document.getElementById("goods-t").innerText = manufacturedGoods;

     document.getElementById("plots-t").innerText = plots;

     document.getElementById("assets-t").innerText = others;



     document.getElementById("loan-t").innerText = loan;

     document.getElementById("instalments-t").innerText = dues;

     document.getElementById("commitee-remaining-t").innerText = remainingCommitee;

     document.getElementById("bills-t").innerText = utilityBills;

     document.getElementById("dealers-t").innerText = dealers;

     document.getElementById("salaries-t").innerText = salaries;

     document.getElementById("unpaid-t").innerText = unpaidZakah;

     if (amountPayable < amountDeducted) {
         amountOfZakah = 0
         finalZakah = 0
     } else {
     ...
     let explanation = `<br/> 1) Amount Payable: ${amountPayable} <br/> 2) Amount Deducted: ${amountDeducted} <br/> 3) Amount On Which Zakah To Be Calculate: ${amountOfZakah} <br/> 4) Zakah To Pay: "${finalZakah}"`
